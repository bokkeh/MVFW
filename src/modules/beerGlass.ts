...
const potionCup = new GLTFShape("models/bloodmoon-cup.glb")

// NOTE: We're matching the beer object's position in the array with the id - this is not good
const beerGlass1 = new BeerGlass(0, beerGlassShape, new Vector3(13.5, 1, 5), new Vector3(0, -0.4, 0.5), -10)
const beerGlass2 = new BeerGlass(1, potionCup, new Vector3(13.5, 1, 3.5), new Vector3(0, -0.4, 0.5), -10)
const beerGlass3 = new BeerGlass(2, beerGlassShape, new Vector3(13.5, 1, 4), new Vector3(0, -0.4, 0.5), -10)
const beerGlass4 = new BeerGlass(3, potionCup, new Vector3(13.5, 1, 4.5), new Vector3(0, -0.4, 0.5), -10)
const beerGlass5 = new BeerGlass(4, beerGlassShape, new Vector3(2, 1, 4), new Vector3(0, -0.4, 0.5), -10)
const beerGlass6 = new BeerGlass(5, potionCup, new Vector3(1, 1, 4.5), new Vector3(0, -0.4, 0.5), -10)
const beerGlass7 = new BeerGlass(6, beerGlassShape, new Vector3(.5, 1, 4), new Vector3(0, -0.4, 0.5), -10)
const beerGlass8 = new BeerGlass(7, beerGlassShape, new Vector3(1.5, 1, 5), new Vector3(0, -0.4, 0.5), -10)
const beerGlass9 = new BeerGlass(8, beerGlassShape, new Vector3(.5, 1, 5), new Vector3(0, -0.4, 0.5), -10)
const beerGlass10 = new BeerGlass(9, beerGlassShape, new Vector3(1.5, 1, 4), new Vector3(0, -0.4, 0.5), -10)
